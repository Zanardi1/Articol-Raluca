...
def computing_engine():
    b.correlation_factor = s.step_1(VABP=b.volumetric_average_boiling_point, S=b.initial_sulfur_content,
                                    AP=b.aniline_point, SG=b.feed_specific_gravity)
    ...
    b.nume, b.avg, b.alimentare = s.step_15()
    ...
    b.component, b.vol, b.specific_gravity, b.calculated_values, b.normalized_values = s.step_22()
    b.component_table_4, b.yield_wt, b.yield_lb_h, b.calc_wt, b.calc_lb_h, b.normalized_wt, b.normalized_lb_h = s.step_23()
